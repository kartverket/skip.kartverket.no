...
[Grafana](https://grafana.com/oss/) er et av de mer kjente verktøyene for overvåking og observerbarhet som er basert på åpen kildekode. Grafana lar deg finne data i de ulike datakildene i sanntid, og lar deg utforske og visualisere dataene.
 ...
 * Testing og synthetics brukes for syntetisk overvåking.
