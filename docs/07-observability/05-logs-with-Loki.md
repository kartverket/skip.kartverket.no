...
Logger samles inn og lagres i Loki, som er backed av et on-premise S3-kompatibelt Scality-lagringssystem, ett per cluster. Hver Loki-instans er definert som en datakilde i Grafana, som gir verktøy for søk, dashbord og varsling.
