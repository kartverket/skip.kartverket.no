...
- Aktivert riktig [PAM-tilgang](../02-kom-i-gang/04-team/09-pam-google-cloud.md)
- Et repo/oppsett for [Terraform](../03-applikasjon-utrulling/08-github-actions/01-bruk-av-terraform.md) (anbefalt)
