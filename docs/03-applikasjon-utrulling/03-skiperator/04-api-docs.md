...
The enabled flag is immutable - delete and recreate the Application to change.<br/>
        </td>
        <td>false</td>
      </tr>
      <tr>
...
This value is immutable - delete and recreate the Application to change<br/>
          <br/>
            <i>Default</i>: `false`<br/>
        </td>
        <td>false</td>
...
Set Partition equal to replicas to pause updates.<br/>
          <br/>
            <i>Format</i>: int32<br/>
            <i>Minimum</i>: 0<br/>
        </td>
...
Each replica gets its own PVC named `<template.metadata.name>-<app>-<ordinal>`.<br/>
        </td>
        <td>false</td>
      </tr>
    </tbody>
...
Used to prevent switching between Deployment and StatefulSet.<br/>
        </td>
        <td>false</td>
      </tr>
    </tbody>
