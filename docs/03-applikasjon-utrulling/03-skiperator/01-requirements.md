...
Som tidligere nevnt bruker vi GitHub som kodelager på SKIP. Du kan lese mer om hvordan du setter opp en CI/CD-pipeline i dokumentasjonen for [GitHub Actions](../08-github-actions/index.md).
