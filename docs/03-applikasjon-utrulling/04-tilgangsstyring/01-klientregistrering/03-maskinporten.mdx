...
gjennom Kubernetes-operatoren [Digdirator](https://https://github.com/nais/digdirator). Digdirator er en Kubernetes-operator utviklet av NAV sitt plattformteam ([NAIS](https://nais.io)) som skal gjøre det enkelt å deklarativt sette opp og vedlikeholde
