...
<Tabs queryString={"operator"}>
    <TabItem value="skiperator" label="Skiperator">
        ...
        Fordelen med å benytte Skiperator for klientregistrering er at hemmelighetene som Digdirator oppretter blir automatisk injisert som miljøvariabler i deploymenten til application. Dette gjør at applikasjonen enkelt kan få tilgang til hemmelighetene i et kjøretidsmiljø.
