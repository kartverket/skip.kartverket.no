    ...
    <TabItem value="skiperator" label="Skiperator">
        ...
        <Tabs queryString={"idp"}>
            <TabItem value="entraid" label="Entra ID">
                [Skiperator](../03-skiperator/04-api-docs.md) tilbyr støtte for å opprette an app-registrering i Entra ID
                via spesifikasjonen til `Application`.

                Eksempelet under oppretter en app-registrering i Entra ID med følgende konfigurasjon:
