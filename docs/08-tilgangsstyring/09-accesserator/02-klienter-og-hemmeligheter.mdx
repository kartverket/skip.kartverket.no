...
[Maskinporten](./03-api-docs.md#securityconfigspecmaskinporten) og
[Entra ID](./03-api-docs.md#securityconfigspecentraid).
...
konsumere. Du finner API-spesifikasjon for `client-feltet` [her](./03-api-docs.md#securityconfigspecmaskinportenclient).
...
vi mener dekker alle behov på SKIP. Du finner API-spesifikasjon for `client-feltet` [her](./03-api-docs.md#securityconfigspecentraidclient).
