...
<table>
    ...
    <tbody><tr>
        ...
        <td>
            ...
            to validate Ansattporten tokens against the audiences specified in `allowedAudiences`.<br/>
        </td>
        <td>false</td>
    </tr><tr>
...
Ansattporten specifies whether to configure Ansattporten token validation for an application referred to by `applicationRef`.
When enabled, an Istio ServiceEntry is created to allow egress to Ansattporten, and the Texas sidecar is configured
to validate Ansattporten tokens against the audiences specified in `allowedAudiences`.
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#securityconfigspecansattportenallowedaudiencesindex">allowedAudiences</a></b></td>
        <td>[]object</td>
        <td>
            AllowedAudiences defines the audience (`aud`) value that Ansattporten tokens are validated against by the Texas
            sidecar. Exactly one audience must be specified when Ansattporten is enabled. The single entry may be a static
...
### SecurityConfig.spec.ansattporten.allowedAudiences[index]
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#securityconfigspecansattportenallowedaudiencesindexvaluefrom">valueFrom</a></b></td>
        <td>object</td>
        <td>
...
### SecurityConfig.spec.ansattporten.allowedAudiences[index].valueFrom
<sup><sup>[↩ Parent](#securityconfigspecansattportenallowedaudiencesindex)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#securityconfigspecansattportenallowedaudiencesindexvaluefromconfigmapkeyref">configMapKeyRef</a></b></td>
        <td>object</td>
        <td>
        ...
        <td><b><a href="#securityconfigspecansattportenallowedaudiencesindexvaluefromsecretkeyref">secretKeyRef</a></b></td>
        <td>object</td>
        <td>
...
### SecurityConfig.spec.ansattporten.allowedAudiences[index].valueFrom.configMapKeyRef
<sup><sup>[↩ Parent](#securityconfigspecansattportenallowedaudiencesindexvaluefrom)</sup></sup>
...
### SecurityConfig.spec.ansattporten.allowedAudiences[index].valueFrom.secretKeyRef
<sup><sup>[↩ Parent](#securityconfigspecansattportenallowedaudiencesindexvaluefrom)</sup></sup>
