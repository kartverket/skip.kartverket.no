...
1. Opprett Altinn Studio-bruker
2. Opprett forespørsel i PureService. Oppgi at du trenger tilgang til Altinn Studio. I testmiljøet er de nødvendige
   gruppene `Resources-Publish-TT02` og `AccessLists-TT02`.
...
Konsumenter må delegere tilgangen videre i Altinn, dvs. gi _fullmakt_ til et API i Altinn. Din Altinn-ressurs vil dukke opp som et valg for
delegering. [Du finner Altinn sin dokumentasjon for delegering av tilgang her](https://info.altinn.no/hjelp/ny-tilgangsstyring/maskinportenadministrasjon/gi-fullmakt-til-api-i-altinn/).
Den ansatte i konsumentens virksomhet som skal gi fullmakt må ha visse tilgangspakker, som er beskrevet i Altinn sin
dokumentasjon.

Inne i Altinn-løsningen må konsumenten velge hvilken leverandør de skal gi fullmakt til. Deretter må de velge hvilket
API de vil gi leverandøren fullmakt til. Du som API-tilbyder i Kartverket bør dokumentere i din API-dokumentasjon
hvilket API, dvs. hvilken Altinn-ressurs av typen `MaskinportenSchema`, konsumenten skal gi fullmakt til. Det kan også
være lurt å referere til Altinn sin dokumentasjon, eller dokumentere hvilke tilgangspakker som kreves for å gi fullmakt.
...
Maskinporten går god for fullmaktsforholdet mellom consumer og supplier. I motsetning til ved bruk av systembrukere
trengs det altså ikke noe PDP-oppslag eller annet oppslag mot Altinn for å verifisere dette.
