...
Ztoperator har aktive deprecation warnings, se [deprecation warnings](#%EF%B8%8F-deprecation-warnings) for mer informasjon.
...
Merk at dette kun vil hindre oppstart av _nye_ pods, og ikke hindre _eksisterende_ pods fra å fungere som før. Dette er
...
- [Eksempeloppsett av Ztoperator: Microsoft Entra ID](01-kom-i-gang.mdx#--microsoft-entra-id)
- [Eksempeloppsett av Ztoperator: ID-Porten](01-kom-i-gang.mdx#-id-porten)
- [Eksempeloppsett av Ztoperator: Ansattporten](01-kom-i-gang.mdx#-ansattporten)

## 🛠 Støttede identitetstilbydere

| Miljø | Identitetstilbyder | `wellKnownURI` | SKIP DEV | SKIP PROD |
| --- | --- | --- | --- | --- |
...
| `TEST` | Databricks | [https://2004011444667850.0.gcp.databricks.com/oidc/.well-known/openid-configuration](https://2004011444667850.0.gcp.databricks.com/oidc/.well-known/openid-configuration) | ✅ | ❌ |
| `PROD` | Databricks | [https://3359340685875444.4.gcp.databricks.com/oidc/.well-known/openid-configuration](https://3359340685875444.4.gcp.databricks.com/oidc/.well-known/openid-configuration) | ❌ | ✅|
