...
The normative behaviour for an OAuth / OIDC-compliant identity provider is to validate the presence of one or more client IDs as allowed audiences.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
Baseline authentication applies to all combinations of paths and methods not explicitly ignored by .ignoreAuthRules.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
The request is permitted if all the specified conditions are satisfied.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
<sup><sup>[↩ Parent](#authpolicyspecbaselineauth)</sup></sup>
