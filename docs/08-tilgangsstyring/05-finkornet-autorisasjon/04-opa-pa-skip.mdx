...
Hvilke felter som eksisterer for OPA i `SecurityConfig` og hva de gjør kan du lese mer om i [API-dokumentasjonen](../09-accesserator/03-api-docs.md#securityconfigspecopa).
