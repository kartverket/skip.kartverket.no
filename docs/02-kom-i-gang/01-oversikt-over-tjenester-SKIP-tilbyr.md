...
|-----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Google Anthos                                             | - [https://cloud.google.com/anthos/](https://cloud.google.com/anthos/)                                                                                                                 | [Google Cloud Console](https://console.cloud.google.com/)                                                                                                                                      |
| Google Cloud Storage                                     | - [Sikker bruk av Terraform State på Google Cloud Storage](https://kartverket.atlassian.net/wiki/spaces/SKIPDOK/pages/306810004/Sikker+bruk+av+Terraform+State+p+Google+Cloud+Storage) |         [Google Cloud Storage](https://console.cloud.google.com/storage/) |                                                                                                                                                                                          
...
| Privileged Access Manager (PAM)                           | - [Privileged Access Manager (PAM)](./04-team/09-pam-google-cloud.md)                                                                                                                 | [Google Cloud Console](https://console.cloud.google.com/iam-admin/pam/entitlements/)                                                                                                                                       |
...
| Argo CD                                                    | [Komme i gang med Argo CD](../03-applikasjon-utrulling/09-argo-cd/01-komme-i-gang-med-argocd.md)                                                                                                                |                                                                                                                                                                                                 |
...
I stedet for å skrive en full manual om alle de tjenestene og programvarene som SKIP tilbyr og er basert på, har vi skrevet litt kort om hver tjeneste du som utvikler kan bruke, og hvordan den ser ut under panseret. Hvis det finnes mer dokumentasjon fra SKIP om tjenesten vil det være linket til her, men hvis du ønsker et skikkelig dypdykk vil det
...
Grafana Mimir lagrer metrikker fra applikasjoner, og brukes som datakilde for Grafana.

Grafana Tempo lagrer tracing for applikasjoner, og brukes som datakilde for Grafana.

Grafana Alerting brukes for å sende ut varslinger basert på data i Grafana.
...
I GSM opprettes hemmeligheter per prosjekt, og du kan adgangskontrollere både for et helt prosjekt og for individuelle hemmeligheter. Hemmeligheter kan versjoneres og rulleres automatisk.
...
GitHub er en skybasert git-repository-tjeneste som vi bruker til å lagre kildekoden til Kartverkets prosjekter. Med GitHub får vi også mye annet, blant annet kontinuerlig integrasjon og kodescanning.

### Objektlagring

SKIP tilbyr flere objektlagringstjenester som blant annet gir deg mulighet å lagre filer i sky eller on-prem.

For å lagre filer i sky anbefaler vi å bruke [Google Cloud Storage](https://cloud.google.com/storage/) . Dette er en lagringstjeneste som følger med Google Cloud Platform.
...
I tillegg til lagring med Google cloud storage kan du bruke [Scality on-prem](../06-lagring/02-objektlagring-scality-s3.md) som er et AWS S3-kompatibelt alternativ.

### Continuous Deployment

Argo CD er et deklarativt, GitOps-basert verktøy for kontinuerlig levering av Kubernetes-applikasjoner. Det automatiserer distribusjon og administrasjon av applikasjoner i Kubernetes ved å
