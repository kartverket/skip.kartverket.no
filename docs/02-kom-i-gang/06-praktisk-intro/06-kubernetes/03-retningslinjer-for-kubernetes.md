...
Requests er hvor mye CPU og minne hver container spør om når den først settes på en node. Hvis man for eksempel ber om 500 mCPUer, men noden bare har 250 mCPU ledig, kan containeren ikke kjøres på den noden.

Merk at man kan spesifisere CPU helt ned i millicpuer (mCPU).

Minne-requests kan settes i mange forskjellige enheter, se [dokumentasjonen](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for detaljer. Vi anbefaler at man holder seg til M - megabytes.
...
Dersom det faktiske forbruket nærmer seg limiten av naturlige årsaker – flere requests eller tyngre load+ – er det på tide å øke limiten. Ikke vent til applikasjonen krasjer - det skaper en dårlig brukeropplevelse.
...
- Resource limits skal alltid settes høyere enn requests, men aldri unaturlig høyt. Husk at dette fungerer både som dokumentasjon og som en sikring mot bugs og feilkonfigurasjon.
