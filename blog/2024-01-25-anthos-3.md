...
to a fear of the unknown, and subsequently inaction. In the end it turned out
that quite a lot of our workloads indeed could run in public cloud, given some
minor adjustments.
